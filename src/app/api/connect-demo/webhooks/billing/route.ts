...
import { syncConnectedSubscriptionState } from "@/lib/connect-demo/store";
import {
...
async function syncSubscriptionToDatabase(
  ...
  // Per V2 account guidance, use customer_account (acct_...) and avoid customer IDs.
...
export async function POST(request: Request) {
  ...
  // This billing webhook consumes regular (non-thin) Stripe events.
  ...
  try {
    switch (event.type) {
      ...
      case "billing_portal.session.created": {
        // TODO: Write any product-access, billing-profile, or audit side effects here.
        // These events are acknowledged so you can extend entitlement logic safely.
        break;
      }
